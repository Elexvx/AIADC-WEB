    ...
    <ScrollReveal className="grid gap-5 md:grid-cols-2 xl:grid-cols-3" staggerChildren>
      {projects.map((project) => (
        ...
        >
          ...
          <div className="mt-5 flex flex-wrap gap-x-4 gap-y-2 text-sm font-semibold text-slate-500">
          ...
          <InternalLink
            ...
            className="mt-4 inline-flex h-9 w-fit items-center gap-2 self-start rounded-md border border-blue-200 bg-white px-4 text-sm font-bold text-blue-700 transition-colors hover:bg-blue-50"
          >
            查看详情
