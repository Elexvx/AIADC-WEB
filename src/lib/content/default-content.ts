  ...
  const home = page(locale, 'home', {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          record(locale, 'partner-un', 'un', { title: '联合国相关机构', subtitle: '合作支持', imageUrl: '/assets/partners/partner-un.png', sort: 1 }),
          record(locale, 'partner-aliyun', 'aliyun', { title: '阿里云', subtitle: '技术支持', imageUrl: '/assets/partners/partner-aliyun.png', sort: 2 }),
          record(locale, 'partner-tencent', 'tencent', { title: '腾讯云', subtitle: '技术支持', imageUrl: '/assets/partners/partner-tencent.png', sort: 3 }),
          record(locale, 'partner-baidu', 'baidu', { title: '百度智能云', subtitle: '技术支持', imageUrl: '/assets/partners/partner-baidu.png', sort: 4 }),
          record(locale, 'partner-deepseek', 'deepseek', { title: 'DeepSeek', subtitle: '模型生态', imageUrl: '/assets/partners/partner-deepseek.png', sort: 5 }),
          record(locale, 'partner-tongyi', 'tongyi', { title: '通义千问', subtitle: '模型生态', imageUrl: '/assets/partners/partner-tongyi.png', sort: 6 }),
          record(locale, 'partner-bytedance', 'bytedance', { title: '字节跳动', subtitle: '生态支持', imageUrl: '/assets/partners/partner-bytedance.png', sort: 7 }),
          record(locale, 'partner-feishu', 'feishu', { title: '飞书', subtitle: '协作支持', imageUrl: '/assets/partners/partner-feishu.png', sort: 8 }),
          record(locale, 'partner-alipay', 'alipay', { title: '支付宝', subtitle: '生态支持', imageUrl: '/assets/partners/partner-alipay.png', sort: 9 }),
          record(locale, 'partner-jadeisle', 'jadeisle', { title: 'Jadeisle', subtitle: '合作支持', imageUrl: '/assets/partners/partner-jadeisle.png', sort: 10 }),
        ],
      },
      {
        id: 'home-faq',
