  ...
  return (
    ...
    >
      <div className="section-shell relative flex items-center justify-center gap-3 py-2.5 sm:py-3">
        ...
        <p className="min-w-0 max-w-full truncate pr-8 text-center text-sm font-medium tracking-[0] text-[#31302e] transition-colors dark:text-white/82 sm:pr-12 sm:text-[15px]">
          2026 年报名征集与材料提交进行中 · 2026年7月1日 - 2026年9月30日
        </p>

        <ChevronRight className="pointer-events-none absolute right-4 h-4 w-4 shrink-0 text-[#0075de] transition-colors duration-200 group-hover:text-[#005bab] dark:text-white/82" />
      </div>
    </InternalLink>
  );
}
