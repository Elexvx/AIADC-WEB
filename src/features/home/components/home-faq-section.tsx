    ...
    <section id="faq" className="bg-white py-10 sm:py-12">
      <div className="section-shell">
        ...
        <div className="mt-9 grid gap-4 md:grid-cols-2">
          {faqItems.map((item) => (
            <Card key={item.id} className="rounded-lg border-slate-200 bg-white shadow-[0_14px_36px_rgba(15,23,42,0.06)]">
              <CardContent className="flex min-h-36 items-start gap-4 !p-6">
                ...
                <div className="min-w-0 pt-0.5">
                  <h3 className="text-base font-black leading-6 tracking-[-0.03em] text-slate-950">{item.title}</h3>
