...
export default async function NewsDetailPage({ params }: NewsDetailPageProps) {
  ...
  return (
    <main className="article-page min-h-screen bg-background">
      <article className="article-body relative pb-14 pt-12 sm:pb-20 sm:pt-16">
        <div className="section-shell">
          <div className="mx-auto max-w-[900px]">
            ...
            <header className="article-header mx-auto mt-8 max-w-[760px] text-center sm:mt-10">
              <p className="article-meta text-sm font-semibold text-[#38342f]">{categoryLabel}</p>
              <h1 className="article-title mx-auto mt-5 max-w-[760px] text-balance text-[2rem] font-bold leading-[1.18] text-[#111111] sm:text-[2.75rem]">
                {article.title}
              </h1>
            ...
            {hasMarkdown ? (
              ...
              <div className="article-content mt-9 max-w-[760px] space-y-6">
            ...
            <nav className="article-footer-divider mt-14 flex items-center justify-between gap-4 border-t border-[#111111]/25 pt-6">
              {prevArticle ? (
                <InternalLink
          ...
          {relatedArticles.length > 0 ? (
            <section className="article-related mx-auto mt-14 max-w-[900px] border-t border-[#111111]/25 pt-10 sm:mt-20 sm:pt-12">
